...
Write-Host ""
Write-Host "Done. Next, connect mimir to your AI client - mimir-setup does both the MCP"
Write-Host "server registration and the workflow instructions:"
Write-Host ""
Write-Host "  Personal use, nothing shared yet (no files added to any repo):"
Write-Host "    mimir-setup claude --global        # Claude Code"
Write-Host "    mimir-setup copilot-cli --global   # GitHub Copilot CLI"
Write-Host ""
Write-Host "  Ready to share with a team on this project (writes committed .mcp.json"
Write-Host "  for claude; copilot-cli has no project scope, always registers at"
Write-Host "  ~/.copilot/mcp-config.json):"
Write-Host "    mimir-setup            # defaults to claude"
Write-Host "    mimir-setup copilot-cli"
