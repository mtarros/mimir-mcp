...
Write-Host ""
Write-Host "  Then, per project - adds workflow instructions + .mimirignore (still"
Write-Host "  needed even after the user-scope connect above, since these are"
Write-Host "  project-specific, not MCP registration):"
Write-Host "    mimir-setup                        # CLAUDE.md (default)"
Write-Host "    mimir-setup copilot                # or copilot-instructions.md"
Write-Host "    mimir-setup [claude|copilot] --global   # write to user profile instead (no repo files at all)"
