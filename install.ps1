...
Write-Host "    mimir-setup copilot --global    # GitHub Copilot in VS Code"
Write-Host ""
Write-Host "  Ready to share with a team on this project (writes committed .mcp.json /"
Write-Host "  .vscode/mcp.json + CLAUDE.md / copilot-instructions.md):"
Write-Host "    mimir-setup            # defaults to claude"
Write-Host "    mimir-setup copilot"
