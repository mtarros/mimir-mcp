...
echo ""
echo "  Then, per project — adds workflow instructions + .mimirignore (still"
echo "  needed even after the user-scope connect above, since these are"
echo "  project-specific, not MCP registration):"
echo "    mimir-setup                        # CLAUDE.md (default)"
echo "    mimir-setup copilot                # or copilot-instructions.md"
echo "    mimir-setup [claude|copilot] --global   # write to user profile instead (no repo files at all)"
